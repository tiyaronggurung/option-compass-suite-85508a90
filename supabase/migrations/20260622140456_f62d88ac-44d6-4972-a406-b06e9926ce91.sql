...
-- Lower default starting balance to $1,000 for new signups
...
-- Reset function now rebases to $1,000
...
BEGIN
  ...
  INSERT INTO public.paper_accounts (user_id, starting_balance, cash_balance, day_start_equity)
  VALUES (auth.uid(), 1000, 1000, 1000)
...
-- Global wipe + rebase to $1,000 for every existing user
DELETE FROM public.trade_alerts;
