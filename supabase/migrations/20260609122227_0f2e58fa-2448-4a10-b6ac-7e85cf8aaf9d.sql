CREATE OR REPLACE FUNCTION public.get_leaderboard(_window text DEFAULT 'all'::text)
 RETURNS TABLE(user_id uuid, display_name text, realized_pl numeric, live_equity numeric, closed_trades bigint)
 LANGUAGE sql
