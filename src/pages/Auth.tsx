      ...
      <div className="hidden lg:flex flex-col justify-between p-10 relative overflow-hidden border-r border-border"
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase tracking-[0.2em] text-primary">AI Pro</div>
          </div>
        </Link>
        ...
        <div className="text-xs text-muted-foreground">© OptionFlow AI Pro — educational use only.</div>
      </div>
