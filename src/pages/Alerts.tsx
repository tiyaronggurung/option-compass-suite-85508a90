...
export default function Alerts() {
  ...
  async function enableBrowserPush(enable: boolean) {
    ...
    if (enable) {
      try { new Notification("Xalgoflow alerts enabled", { body: "You'll receive alerts that match your thresholds." }); } catch {}
    }
  }
      ...
      <section className="glass-card p-5 space-y-4">
        ...
        >
          <p className="text-xs text-muted-foreground">
            Live in this browser tab. Shows desktop notifications for matching signals while Xalgoflow is open.
          </p>
